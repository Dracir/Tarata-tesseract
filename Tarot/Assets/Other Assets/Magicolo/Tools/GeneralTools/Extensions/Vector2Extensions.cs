...
namespace Magicolo {
	public static class Vector2Extensions {
		...
		public static Vector2 OscillateAngles(this Vector2 vector, Vector2 frequency, Vector2 amplitude, Vector2 center, float offset, Axis axis) {
		...
		public static Vector2 OscillateAngles(this Vector2 vector, Vector2 frequency, Vector2 amplitude, Vector2 center, float offset) {
			return vector.OscillateAngles(frequency, amplitude, center, offset, Axis.XY);
		}

		public static Vector2 OscillateAngles(this Vector2 vector, Vector2 frequency, Vector2 amplitude, Vector2 center, Axis axis) {
		...
		public static Vector2 OscillateAngles(this Vector2 vector, Vector2 frequency, Vector2 amplitude, Vector2 center) {
			return vector.OscillateAngles(frequency, amplitude, center, 0, Axis.XY);
		}
