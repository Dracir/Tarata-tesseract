...
namespace Magicolo {
	public static class Rigidbody2DExtension {
		...
		public static void OscillateEulerAngles(this Rigidbody2D rigidbody, float frequency, float amplitude, float center) {
			rigidbody.SetEulerAngles(rigidbody.transform.eulerAngles.OscillateAngles(new Vector3(frequency, frequency, frequency), new Vector3(amplitude, amplitude, amplitude), new Vector3(center, center, center), rigidbody.GetInstanceID() / 1000, Axis.Z).z);
		}
