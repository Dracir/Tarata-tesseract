...
namespace Magicolo {
	public static class Vector3Extensions {
		...
		public static Vector3 OscillateAngles(this Vector3 vector, Vector3 frequency, Vector3 amplitude, Vector3 center, float offset, Axis axis) {
		...
		public static Vector3 OscillateAngles(this Vector3 vector, Vector3 frequency, Vector3 amplitude, Vector3 center, float offset) {
			return vector.OscillateAngles(frequency, amplitude, center, offset, Axis.XYZ);
		}

		public static Vector3 OscillateAngles(this Vector3 vector, Vector3 frequency, Vector3 amplitude, Vector3 center, Axis axis) {
		...
		public static Vector3 OscillateAngles(this Vector3 vector, Vector3 frequency, Vector3 amplitude, Vector3 center) {
			return vector.OscillateAngles(frequency, amplitude, center, 0, Axis.XYZ);
		}
